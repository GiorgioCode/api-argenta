    ...
    <div className="home-container">
      <header className="home-header">
        <div className="logo-container">
          <img src="/logo.png" alt="Mockup JSON Argentina Logo" className="home-logo" width="360" />
  ...
  .then(data => {
    ...
    // Usar los datos...
      ...
      <footer className="home-footer">
        <p>Desarrollado por: <a href="https://jorgepaez.vercel.app" target="_blank" rel="noopener noreferrer">Jorge Angel Paez</a></p>
      </footer>
    </div>
  );
};
